...
export const safaris: Safari[] = [
  {
    slug: 'gorillas-and-the-great-rift', title: 'Gorillas & the Great Rift', country: 'Uganda', days: 8, category: 'Gorilla trekking', image: `${import.meta.env.BASE_URL}images/gorilla.jpg`, tag: 'THE KIBIRA SIGNATURE',
  ...
  {
    slug: 'the-wild-heart-of-kenya', title: 'The Wild Heart of Kenya', country: 'Kenya', days: 7, category: 'Wildlife safari', image: `${import.meta.env.BASE_URL}images/kenya.jpg`, tag: 'WIDE-OPEN WONDERS',
  ...
  {
    slug: 'rwanda-beyond-the-mist', title: 'Rwanda, Beyond the Mist', country: 'Rwanda', days: 6, category: 'Gorilla trekking', image: `${import.meta.env.BASE_URL}images/rwanda.jpg`, tag: 'A DIFFERENT PERSPECTIVE',
  ...
  {
    slug: 'serengeti-under-canvas', title: 'Serengeti, Under Canvas', country: 'Tanzania', days: 9, category: 'Wildlife safari', image: `${import.meta.env.BASE_URL}images/tanzania.jpg`, tag: 'THE CLASSIC, REIMAGINED',
  ...
  {
    slug: 'uganda-at-your-own-pace', title: 'Uganda, at Your Own Pace', country: 'Uganda', days: 12, category: 'Family & slow travel', image: `${import.meta.env.BASE_URL}images/game-drive.jpg`, tag: 'MORE TIME, MORE CONNECTION',
  ...
  {
    slug: 'two-countries-one-extraordinary-journey', title: 'Forests, Plains & Everything Between', country: 'Uganda & Kenya', days: 14, category: 'Private adventure', image: `${import.meta.env.BASE_URL}images/hero-safari.webp`, tag: 'THE GRAND JOURNEY',
...
export const stories = [
  ...
  { slug: 'the-beauty-of-travelling-slowly', title: 'The quiet beauty of travelling a little slower', category: 'A DIFFERENT PERSPECTIVE', readTime: '4 min read', image: `${import.meta.env.BASE_URL}images/rwanda.jpg`, intro: 'There is another way to safari. One with fewer check-ins, less time watching the road, and more time noticing what is right in front of you.', sections: [
  ...
  { slug: 'a-more-thoughtful-safari', title: 'Small choices. A more meaningful safari.', category: 'TRAVEL WITH PURPOSE', readTime: '5 min read', image: `${import.meta.env.BASE_URL}images/kenya.jpg`, intro: 'Responsible travel is not one grand gesture. It is a collection of considered decisions, made before you leave home and carried with you into the wild.', sections: [
